...
declare module AceAjax {
    ...
    **/
    export interface Ace {
        ...
        **/
        ...
        /**
         * Embeds the Ace markdownEditor into the DOM, at the element provided by `el`.
    ...
    **/
    ...
    var BackgroundTokenizer: {
         ...
         * @param editor The markdownEditor to associate with
        **/
    ...
    **/
    export interface IEditSession {
        ...
        **/
        ...
        /**
         * [Returns the value of the distance between the top of the markdownEditor and the topmost part of the visible content.]{: #EditSession.getScrollTop}
        **/
        getScrollTop(): number;

        /**
         * [Sets the value of the distance between the left of the markdownEditor and the leftmost part of the visible content.]{: #EditSession.setScrollLeft}
        **/
        setScrollLeft();

        /**
         * [Returns the value of the distance between the left of the markdownEditor and the leftmost part of the visible content.]{: #EditSession.getScrollLeft}
        **/
    ...
    **/
    export interface Editor {
        ...
        **/
        ...
        /**
         * Set a new font size (in pixels) for the markdownEditor text.
        ...
        **/
        ...
        /**
         * Emitted once the markdownEditor comes into focus.
        **/
        onFocus();

        /**
         * Emitted once the markdownEditor has been blurred.
        **/
        onBlur();
        ...
        **/
        ...
        /**
         * If `showInvisibiles` is set to `true`, invisible characters&mdash;like spaces or new lines&mdash;are show in the markdownEditor.
        ...
        **/
        ...
        /**
         * If `showPrintMargin` is set to `true`, the print margin is shown in the markdownEditor.
        ...
        **/
        ...
        /**
         * If `readOnly` is true, then the markdownEditor is set to read-only mode, and none of the content can change.
         * @param readOnly Specifies whether the markdownEditor can be modified or not
        **/
        setReadOnly(readOnly: boolean);

        /**
         * Returns `true` if the markdownEditor is set to read-only mode.
        **/
        getReadOnly(): boolean;
        ...
        **/
        ...
        /**
         * Removes words of text from the markdownEditor. A "word" is defined as a string of characters bookended by whitespace.
        ...
        **/
        ...
        /**
         * Moves the markdownEditor to the specified row.
        **/
        scrollToRow();
        ...
        **/
        ...
        /**
         * Selects all the text in markdownEditor.
        **/
        selectAll();
        ...
        **/
        ...
        /**
         * Cleans up the entire markdownEditor.
        **/
        destroy();
    ...
    /**
     * This object is used in various places to indicate a region within the markdownEditor. To better visualize how this works, imagine a rectangle. Each quadrant of the rectangle is analogus to a range, as ranges contain a starting row and starting column, and an ending row, and ending column.
    **/
    ...
    **/
    ...
    /**
     * A set of methods for setting and retrieving the markdownEditor's scrollbar.
    **/
    ...
    **/
    export interface Selection {
        ...
        **/
        ...
        /**
         * Moves the cursor to the row and column provided. [If `preventUpdateDesiredColumn` is `true`, then the cursor stays in the same column position as its original point.]{: #preventUpdatebooleanDesc}
         * @param row The row to move to
         * @param column The column to move to
         * @param keepDesiredColumn [If `true`, the cursor move does not respect the previous column]{: #preventUpdateboolean}
        **/
        moveCursorTo(row: number, column: number, keepDesiredColumn?: boolean);

        /**
         * Moves the cursor to the screen position indicated by row and column. {:preventUpdatebooleanDesc}
         * @param row The row to move to
         * @param column The column to move to
         * @param keepDesiredColumn {:preventUpdateboolean}
        **/
    ...
    export interface Split {
        ...
        **/
        ...
        /**
         * Returns the markdownEditor identified by the index `idx`.
         * @param idx The index of the markdownEditor you want
        **/
        getEditor(idx: number);

        /**
         * Returns the current markdownEditor.
        **/
        getCurrentEditor(): Editor;

        /**
         * Focuses the current markdownEditor.
        **/
        focus();

        /**
         * Blurs the current markdownEditor.
        **/
        blur();
        ...
        **/
        ...
        /**
         * Sets the keyboard handler for the markdownEditor.
         * @param keybinding
        **/
        ...
        **/
        ...
        /**
         * Sets a new [[EditSession `EditSession`]] for the indicated markdownEditor.
         * @param session The new edit session
         * @param idx The markdownEditor's index you're interested in
        **/
    ...
    **/
    export interface VirtualRenderer {
        ...
        **/
        ...
        /**
         * [Triggers a resize of the markdownEditor.]{: #VirtualRenderer.onResize}
         * @param force If `true`, recomputes the size, even if the height and width haven't changed
         * @param gutterWidth The width of the gutter in pixels
         * @param width The width of the markdownEditor in pixels
         * @param height The hiehgt of the markdownEditor, in pixels
        **/
        ...
        **/
        ...
        /**
         * Scrolls the cursor into the first visibile area of the markdownEditor
        **/
        ...
        **/
        ...
        /**
         * Gracefully scrolls from the top of the markdownEditor to the row indicated.
         * @param row A row id
        **/
        scrollToRow(row: number);

        /**
         * Gracefully scrolls the markdownEditor to the row indicated.
         * @param line A line number
         * @param center If `true`, centers the markdownEditor the to indicated line
         * @param animate If `true` animates scrolling
        ...
        **/
        ...
        /**
         * Scrolls the markdownEditor to the y pixel indicated.
         * @param scrollTop The position to scroll to
        **/
        scrollToY(scrollTop: number): number;

        /**
         * Scrolls the markdownEditor across the x-axis to the pixel indicated.
         * @param scrollLeft The position to scroll to
        **/
        scrollToX(scrollLeft: number): number;

        /**
         * Scrolls the markdownEditor across both x- and y-axes.
        ...
        **/
        ...
        /**
         * [Sets a new theme for the markdownEditor. `theme` should exist, and be a directory path, like `ace/theme/textmate`.]{: #VirtualRenderer.setTheme}
         * @param theme The path to a theme
        **/
        setTheme(theme: string);
        ...
        **/
        ...
        /**
         * [Adds a new class, `style`, to the markdownEditor.]{: #VirtualRenderer.setStyle}
         * @param style A class name
        **/
        setStyle(style: string);

        /**
         * [Removes the class `style` from the markdownEditor.]{: #VirtualRenderer.unsetStyle}
         * @param style A class name
        **/
    ...
    var VirtualRenderer: {
         ...
         * @param container The root element of the markdownEditor
